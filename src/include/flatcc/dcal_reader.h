...
typedef struct DCAL_session_Handshake_table *DCAL_session_Handshake_mutable_table_t;
...
typedef struct DCAL_session_Event_table *DCAL_session_Event_mutable_table_t;
...
typedef struct DCAL_session_U32_table *DCAL_session_U32_mutable_table_t;
...
typedef struct DCAL_session_String_table *DCAL_session_String_mutable_table_t;
...
typedef struct DCAL_session_Status_table *DCAL_session_Status_mutable_table_t;
...
typedef struct DCAL_session_Version_table *DCAL_session_Version_mutable_table_t;
...
typedef struct DCAL_session_Globals_table *DCAL_session_Globals_mutable_table_t;
...
typedef struct DCAL_session_Profile_table *DCAL_session_Profile_mutable_table_t;
...
typedef struct DCAL_session_Interface_table *DCAL_session_Interface_mutable_table_t;
...
typedef struct DCAL_session_Lease_table *DCAL_session_Lease_mutable_table_t;
...
typedef struct DCAL_session_Default_route_table *DCAL_session_Default_route_mutable_table_t;
...
typedef struct DCAL_session_P_entry_table *DCAL_session_P_entry_mutable_table_t;
...
typedef struct DCAL_session_Profile_list_table *DCAL_session_Profile_list_mutable_table_t;
...
typedef struct DCAL_session_Scan_item_table *DCAL_session_Scan_item_mutable_table_t;
...
typedef struct DCAL_session_Scan_list_table *DCAL_session_Scan_list_mutable_table_t;
...
typedef struct DCAL_session_Time_table *DCAL_session_Time_mutable_table_t;
...
typedef struct DCAL_session_Filexfer_table *DCAL_session_Filexfer_mutable_table_t;
...
typedef struct DCAL_session_Command_table *DCAL_session_Command_mutable_table_t;
...
static inline int DCAL_session_Magic_is_known_value(DCAL_session_Magic_enum_t value)
{
    switch (value) {
    case DCAL_session_Magic_INVALID: return 1;
    case DCAL_session_Magic_HELLO: return 1;
    case DCAL_session_Magic_NACK: return 1;
    case DCAL_session_Magic_ACK: return 1;
    default: return 0;
    }
}
...
static inline int DCAL_session_Commands_is_known_value(DCAL_session_Commands_enum_t value)
{
    switch (value) {
    case DCAL_session_Commands_INVALID: return 1;
    case DCAL_session_Commands_GETVERSIONS: return 1;
    case DCAL_session_Commands_GETSTATUS: return 1;
    case DCAL_session_Commands_GETGLOBALS: return 1;
    case DCAL_session_Commands_SETGLOBALS: return 1;
    case DCAL_session_Commands_GETPROFILE: return 1;
    case DCAL_session_Commands_SETPROFILE: return 1;
    case DCAL_session_Commands_DELPROFILE: return 1;
    case DCAL_session_Commands_GETPROFILELIST: return 1;
    case DCAL_session_Commands_GETSCANLIST: return 1;
    case DCAL_session_Commands_ACTIVATEPROFILE: return 1;
    case DCAL_session_Commands_GETINTERFACE: return 1;
    case DCAL_session_Commands_SETINTERFACE: return 1;
    case DCAL_session_Commands_DELINTERFACE: return 1;
    case DCAL_session_Commands_GETLEASE: return 1;
    case DCAL_session_Commands_GETDEFAULTROUTE: return 1;
    case DCAL_session_Commands_WIFIENABLE: return 1;
    case DCAL_session_Commands_WIFIDISABLE: return 1;
    case DCAL_session_Commands_WIFIRESTART: return 1;
    case DCAL_session_Commands_SYSTEMREBOOT: return 1;
    case DCAL_session_Commands_SETTIME: return 1;
    case DCAL_session_Commands_GETTIME: return 1;
    case DCAL_session_Commands_NTPDATE: return 1;
    case DCAL_session_Commands_FILEPUSH: return 1;
    case DCAL_session_Commands_FILEPULL: return 1;
...
__flatbuffers_define_union(flatbuffers_, DCAL_session_Cmd_pl)
...
static inline int DCAL_session_Cmd_pl_is_known_type(DCAL_session_Cmd_pl_union_type_t type)
{
    switch (type) {
    case DCAL_session_Cmd_pl_NONE: return 1;
    case DCAL_session_Cmd_pl_Globals: return 1;
    case DCAL_session_Cmd_pl_Profile: return 1;
    case DCAL_session_Cmd_pl_Interface: return 1;
    case DCAL_session_Cmd_pl_Lease: return 1;
    case DCAL_session_Cmd_pl_Default_route: return 1;
    case DCAL_session_Cmd_pl_U32: return 1;
    case DCAL_session_Cmd_pl_String: return 1;
    case DCAL_session_Cmd_pl_Time: return 1;
    case DCAL_session_Cmd_pl_Filexfer: return 1;
    default: return 0;
    }
}
...
__flatbuffers_define_union_field(flatbuffers_, 2, DCAL_session_Command, cmd_pl, DCAL_session_Cmd_pl, 0)
