...
typedef const struct DCAL_session_Profiles_table *DCAL_session_Profiles_table_t;
typedef const flatbuffers_uoffset_t *DCAL_session_Profiles_vec_t;
typedef flatbuffers_uoffset_t *DCAL_session_Profiles_mutable_vec_t;
...
#define DCAL_session_Commands_GETVERSION ((DCAL_session_Commands_enum_t)1UL)
...
static inline const char *DCAL_session_Commands_name(DCAL_session_Commands_enum_t value)
{
    ...
    case DCAL_session_Commands_GETVERSION: return "GETVERSION";
...
struct DCAL_session_Profiles_table { uint8_t unused__; };

#ifndef DCAL_session_Profiles_identifier
#define DCAL_session_Profiles_identifier flatbuffers_identifier
#endif
#define DCAL_session_Profiles_type_hash ((flatbuffers_thash_t)0x60148279)
#define DCAL_session_Profiles_type_identifier "\x79\x82\x14\x60"
static inline size_t DCAL_session_Profiles_vec_len(DCAL_session_Profiles_vec_t vec)
__flatbuffers_vec_len(vec)
static inline DCAL_session_Profiles_table_t DCAL_session_Profiles_vec_at(DCAL_session_Profiles_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(DCAL_session_Profiles_table_t, vec, i, 0)
__flatbuffers_table_as_root(DCAL_session_Profiles)

static inline DCAL_session_Profile_vec_t DCAL_session_Profiles_profiles(DCAL_session_Profiles_table_t t)
__flatbuffers_vector_field(DCAL_session_Profile_vec_t, 0, t, 0)
static inline int DCAL_session_Profiles_profiles_is_present(DCAL_session_Profiles_table_t t)
__flatbuffers_field_present(0, t)
