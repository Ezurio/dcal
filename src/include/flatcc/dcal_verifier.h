...
{
    int ret;
    if ((ret = flatcc_verify_field(td, 0, 4, 4) /* cli */)) return ret;
    if ((ret = flatcc_verify_field(td, 1, 4, 4) /* sdk */)) return ret;
    if ((ret = flatcc_verify_field(td, 2, 4, 4) /* chipset */)) return ret;
