...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Handshake_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Event_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_U32_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_String_table_verifier);
}
...
static int __DCAL_session_Status_table_verifier(flatcc_table_verifier_descriptor_t *td)
{
    ...
    if ((ret = flatcc_verify_vector_field(td, 2, 0, 1, 1, 4294967295ULL) /* ssid */)) return ret;
    ...
    if ((ret = flatcc_verify_vector_field(td, 6, 0, 1, 1, 4294967295ULL) /* mac */)) return ret;
    if ((ret = flatcc_verify_vector_field(td, 7, 0, 1, 1, 4294967295ULL) /* ip */)) return ret;
    if ((ret = flatcc_verify_string_vector_field(td, 8, 0) /* ipv6 */)) return ret;
    if ((ret = flatcc_verify_vector_field(td, 9, 0, 1, 1, 4294967295ULL) /* AP_mac */)) return ret;
    if ((ret = flatcc_verify_vector_field(td, 10, 0, 1, 1, 4294967295ULL) /* AP_ip */)) return ret;
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Status_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Version_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Globals_table_verifier);
}
...
static int __DCAL_session_Profile_table_verifier(flatcc_table_verifier_descriptor_t *td)
{
    ...
    if ((ret = flatcc_verify_vector_field(td, 1, 0, 1, 1, 4294967295ULL) /* ssid */)) return ret;
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Profile_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Interface_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Lease_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Default_route_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_P_entry_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Profile_list_table_verifier);
}
...
static int __DCAL_session_Scan_item_table_verifier(flatcc_table_verifier_descriptor_t *td)
{
    ...
    if ((ret = flatcc_verify_vector_field(td, 4, 0, 1, 1, 4294967295ULL) /* mac */)) return ret;
    if ((ret = flatcc_verify_vector_field(td, 5, 0, 1, 1, 4294967295ULL) /* ssid */)) return ret;
    return flatcc_verify_ok;
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Scan_item_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Scan_list_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Time_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Filexfer_table_verifier);
}
...
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &__DCAL_session_Command_table_verifier);
}
